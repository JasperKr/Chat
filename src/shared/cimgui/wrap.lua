...
M.ColorConvertHSVtoRGB = M.ColorConvertHSVtoRGB or function(i1, i2, i3, o1, o2, o3)
    jit.off(true)
    o1 = o1 or ffi.new("float[1]")
    o2 = o2 or ffi.new("float[1]")
    o3 = o3 or ffi.new("float[1]")
...
M.GetCursorPos = M.GetCursorPos or function(o1)
    jit.off(true)
    o1 = o1 or M.ImVec2_Nil()
...
M.GetCursorScreenPos = M.GetCursorScreenPos or function(o1)
    jit.off(true)
    o1 = o1 or M.ImVec2_Nil()
...
M.GetMousePos = M.GetMousePos or function(o1)
    jit.off(true)
    o1 = o1 or M.ImVec2_Nil()
