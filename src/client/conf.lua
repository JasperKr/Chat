function love.conf(t)
    t.identity = "Chat"                 -- The name of the save directory (string)
    ...
    t.window.title = "Chat"             -- The window title (string)
    ...
    t.window.stencil = false            -- The number of bits per sample in the stencil buffer
    ...
    t.modules.timer = true              -- Enable the timer module (boolean), Disabling it will result 0 delta time
